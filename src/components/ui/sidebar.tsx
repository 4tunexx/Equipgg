  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 hidden w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            dynamicHeight
              ? "md:sticky md:top-2 md:self-start h-auto z-10"
              : "fixed inset-y-0 z-10 h-svh",
            dynamicHeight
              ? undefined
              : side === "left"
