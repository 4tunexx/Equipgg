        ...
        <div className="flex-1 flex justify-center items-center relative">
          ...
          <div className="relative w-full max-w-2xl h-96 flex items-center justify-center group cursor-pointer hover:scale-105 transition-transform duration-300">
            ...
            <Image
              ...
              width={600}
              height={200}
              className={`absolute w-auto h-auto max-w-full max-h-80 object-contain transition-all duration-300 group-hover:animate-logo-shake group-hover:scale-105 group-active:scale-95 group-hover:brightness-110 ${
            ...
            <Image
              ...
              width={380}
              height={120}
              className={`absolute w-auto h-auto max-w-full max-h-52 object-contain transition-all duration-300 group-hover:animate-logo-shake group-hover:scale-105 group-active:scale-95 group-hover:brightness-110 ${
